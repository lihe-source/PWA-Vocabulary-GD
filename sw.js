...
const CACHE_NAME = 'Voc-PWA-V7_4_0';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V7_4_0',
  './app.js?v=V7_4_0',
  './manifest.json?v=V7_4_0',
  './version.json',
  './storage.js?v=V7_4_0',
  './backup-schema.js?v=V7_4_0',
  './study-streak.js?v=V7_4_0',
  './version-manager.js?v=V7_4_0',
  './chart-renderer.js?v=V7_4_0',
  './push-config.js?v=V7_4_0',
  './reminder-manager.js?v=V7_4_0',
  './task-manager.js?v=V7_4_0',
  './network.js?v=V7_4_0',
  './backup-worker-client.js?v=V7_4_0',
  './backup-worker.js?v=V7_4_0',
  './draft-manager.js?v=V7_4_0',
