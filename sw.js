...
const CACHE_NAME = 'Voc-PWA-V7_4_1';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V7_4_1',
  './app.js?v=V7_4_1',
  './manifest.json?v=V7_4_1',
  './version.json',
  './storage.js?v=V7_4_1',
  './backup-schema.js?v=V7_4_1',
  './study-streak.js?v=V7_4_1',
  './version-manager.js?v=V7_4_1',
  './chart-renderer.js?v=V7_4_1',
  './push-config.js?v=V7_4_1',
  './reminder-manager.js?v=V7_4_1',
  './task-manager.js?v=V7_4_1',
  './network.js?v=V7_4_1',
  './backup-worker-client.js?v=V7_4_1',
  './backup-worker.js?v=V7_4_1',
  './draft-manager.js?v=V7_4_1',
