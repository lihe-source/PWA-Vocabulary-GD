...
const CACHE_NAME = 'Voc-PWA-V7_2_3';
const APP_SHELL = [
  './',
  './index.html',
  './style.css?v=V7_2_3',
  './app.js?v=V7_2_3',
  './manifest.json?v=V7_2_3',
  './version.json',
  './storage.js?v=V7_2_3',
  './backup-schema.js?v=V7_2_3',
  './study-streak.js?v=V7_2_3',
  './version-manager.js?v=V7_2_3',
  './chart-renderer.js?v=V7_2_3',
  './push-config.js?v=V7_2_3',
  './reminder-manager.js?v=V7_2_3',
